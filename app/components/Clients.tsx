...
function Clients() {
  return (
    <div className="max-w-[1280px] m-auto flex flex-col items-center justify-center gap-10 my-10 hidden lg:block">
      <h1 className="flex justify-center items-center text-xl lg:text-4xl font-extrabold text-[#C9B18F]">
        Our Retail Partners
      </h1>
